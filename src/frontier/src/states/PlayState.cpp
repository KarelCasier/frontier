...
PlayState::PlayState(std::shared_ptr<TextureManager> textureManager, std::shared_ptr<InputManager> inputManager)
: _textureManager{std::move(textureManager)}
, _inputManager{inputManager}
, _world{_textureManager, inputManager}
{
}
...
void PlayState::onEnter()
{
    ...
    _bindingContext->addKeyboardActionBinding("ARel", KeyboardBindingData{SDLK_a, ButtonState::RELEASED, ModifierBitset{}});
    ModifierBitset alt{};
